...
# FOR the case when we want some specific inputs in some ports
# --- CONFIGURATION ---
NUM_SAMPLES = 5000
NUM_HEATERS = 21
SCOPE_INDICES = [0, 1, 2, 3, 4, 5, 6] 
INPUT_HEATER_INDICES = [15, 16, 17, 18, 19] 

def collect():
    print("Initializing Hardware...")
    controller = DualAD5380Controller()
    scopes = RigolDualScopes(channels_scope1=[1,2,3,4], channels_scope2=[1,2,3])
